...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    {...props}
  >
    <Button className={cn("w-full sm:w-auto", className)}>{props.children}</Button>
  </AlertDialogPrimitive.Action>
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    {...props}
  >
    <Button variant="outline" className={cn("w-full sm:w-auto", className)}>{props.children}</Button>
  </AlertDialogPrimitive.Cancel>
))
